...
NO_KEY_MESSAGE = (
    "Я пока не могу проверить базу знаний школы: не настроен OpenAI API key. "
...
SCHOOL_SCOPE_KEYWORDS = [
    "qadam", "кадам", "роботик", "robotics", "школ", "курс", "курсы", "кружок", "занят", "урок",
    "пробн", "ребен", "ребён", "дет", "родител", "робот", "робототех", "lego", "лего", "scratch",
    "python", "arduino", "iot", "электрон", "программ", "robo", "цена", "стоим", "прайс", "оплат",
    "скид", "распис", "слот", "мест", "группа", "запис", "заявк", "адрес", "филиал", "район", "локац", "местонахожд",
    "препод", "преподав", "учител", "педагог", "наставник", "команда", "мисси", "видени", "цель",
    "ценност", "kpi", "кпи", "устав", "правил", "безопас", "зачисл", "критери", "пропуск",
    "отработ", "возврат", "замороз", "сертифик", "олимпиад", "соревн", "помещ", "оборуд", "финанс",
    "маркетинг", "воронк", "лиценз", "основан", "открылись", "открыли", "год основания",
]
...
def answer_question_with_rag(
    ...
    system = (
        "Ты Алихан, живой менеджер школы QADAM ROBOTICS. Отвечай клиенту в WhatsApp. "
        "Пиши простыми словами, спокойно и по-человечески, максимум 2-4 коротких абзаца. "
        ...
        "Отвечай только по данным из контекста школы и только на вопросы про школу, курсы, обучение, оплату, расписание, пробное или запись. "
        "Не отвечай на общие вопросы вне темы школы: математика, известные люди, новости, погода, личные темы и т.д. "
        "Не выдумывай цены, адрес, расписание, наличие мест, конкретные даты пробных занятий или обещания. "
        "Если клиент спрашивает про конкретное время, свободные слоты, запись на этой неделе или наличие мест, а точных данных в контексте нет — скажи, что менеджер проверит и ответит. "
        ...
        "В конце можно мягко предложить следующий шаг, если это уместно: пробное занятие, подбор группы или связь с менеджером. "
        "Если заявка уже оформлена, НЕ предлагай записаться на пробное повторно; лучше скажи, что менеджер уже получил заявку и напишет по времени. "
